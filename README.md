...
7. Para provar los endpoints puedes abrir el archivo

`AdventureWorks.postman_collection.json` en postman o cualquier otra aplicacion para probar los endpoint
